...
xg-lyra-course 是本课程的 **AI 知识辅助工具**，将课程中 120+ 小时的讲解、10 个章节、82 篇知识文档提炼为可交互的 Skill，帮助学员在开发实践中快速查阅 Lyra 架构。
...
|------|------|
| 版本 | UE 5.6 |
| 适用场景 | 配合 Lyra Starter 工程，在 Trae / Cursor / Windsurf 等 AI IDE 中使用 |
| 覆盖范围 | Lyra 核心系统架构、设计模式、调用链路、常见开发工作流 |
| 能力边界 | 解释任意系统/类的职责和设计意图、指导框架下添加功能、诊断常见错误 |
...
本仓库中的课程知识内容（README 及 Skill 文档）仅供已购课学员学习和参考使用，不得用于商业再分发。
